...
alter table pronostique add constraint fk_pronostique_vainqueur_16 foreign key (vainqueur) references equipe (id) on delete restrict on update restrict;
create index ix_pronostique_vainqueur_16 on pronostique (vainqueur);
